...
# or
~/py312/bin/python3 ~/.claude/skills/gemini/scripts/gemini.py "<prompt>" [working_dir]
```
...
# Using python3
- command: ~/py312/bin/python3 ~/.claude/skills/gemini/scripts/gemini.py "<prompt>"
```
...
```bash
~/py312/bin/python3 ~/.claude/skills/gemini/scripts/gemini.py "your prompt here"
```
