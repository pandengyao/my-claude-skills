...
```bash
~/py312/bin/python3 skills/baidu-search/scripts/search.py '<JSON>'
```
...
```bash
# Basic search
~/py312/bin/python3 skills/baidu-search/scripts/search.py '{"query":"人工智能"}'

# Filter by time and site
~/py312/bin/python3 skills/baidu-search/scripts/search.py '{
  "query":"最新新闻",
