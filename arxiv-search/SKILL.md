...
```bash
~/py312/bin/python3 [YOUR_SKILLS_DIR]/arxiv-search/arxiv_search.py "your search query" [--max-papers N]
```
...
```bash
~/py312/bin/python3 ~/.deepagents/agent/skills/arxiv-search/arxiv_search.py "deep learning drug discovery" --max-papers 5
```

Search for computational biology papers:
```bash
~/py312/bin/python3 ~/.deepagents/agent/skills/arxiv-search/arxiv_search.py "protein folding prediction"
```

Search for bioinformatics methods:
```bash
~/py312/bin/python3 ~/.deepagents/agent/skills/arxiv-search/arxiv_search.py "genome assembly algorithms"
```
